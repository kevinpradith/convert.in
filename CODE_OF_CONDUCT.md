...
When an incident does occur, it is important to report it promptly. To report a possible violation, email the maintainer at kevinpradithh@gmail.com with "Code of conduct" in the subject line. This project has one maintainer, so a report about the maintainer has nowhere impartial to go inside the project; in that case please raise it with [GitHub Support](https://support.github.com/contact/report-abuse), whose Acceptable Use Policies apply to this repository regardless of what this file says.
